...
class ProductPage(BasePage):
    ...
    def guest_should_see_added_to_cart_message(self):
        assert self.is_element_present(*ProductPageLocators.BASKET_NOTIFICATION), "Added to cart message is not presented"
    ...
    def title_in_added_to_cart_message_should_be_equal_product_title(self):
